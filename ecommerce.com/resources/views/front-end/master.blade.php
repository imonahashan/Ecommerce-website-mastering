...
<head>
    ...
    <!--css-->
    <link  rel="shortcut icon" href="{{ asset('/') }}/front-end/images/favi.png" rel="stylesheet"/>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu1</h6>
                                                    <li><a href="{{ route('women-category') }}">Clothing</a></li>
                                                    <li><a href="{{ route('women-category') }}">Wallets</a></li>
                                                    <li><a href="{{ route('women-category') }}">Shoes</a></li>
                                                    <li><a href="{{ route('women-category') }}">Watches</a></li>
                                                    <li><a href="{{ route('women-category') }}"> Underwear </a></li>
                                                    <li><a href="{{ route('women-category') }}">Accessories</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu2</h6>
                                                    <li><a href="{{ route('women-category') }}">Sunglasses</a></li>
                                                    <li><a href="{{ route('women-category') }}">Wallets,Bags</a></li>
                                                    <li><a href="{{ route('women-category') }}">Footwear</a></li>
                                                    <li><a href="{{ route('women-category') }}">Watches</a></li>
                                                    <li><a href="{{ route('women-category') }}">Accessories</a></li>
                                                    <li><a href="{{ route('women-category') }}">Jewellery</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                    ...
                                    <ul class="dropdown-menu multi-column columns-3">
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu1</h6>
                                                    <li><a href="{{ route('men-category') }}">Clothing</a></li>
                                                    <li><a href="{{ route('men-category') }}">Wallets</a></li>
                                                    <li><a href="{{ route('men-category') }}">Shoes</a></li>
                                                    <li><a href="{{ route('men-category') }}">Watches</a></li>
                                                    <li><a href="{{ route('men-category') }}"> Underwear </a></li>
                                                    <li><a href="{{ route('men-category') }}">Accessories</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu2</h6>
                                                    <li><a href="{{ route('men-category') }}">Sunglasses</a></li>
                                                    <li><a href="{{ route('men-category') }}">Wallets,Bags</a></li>
                                                    <li><a href="{{ route('men-category') }}">Footwear</a></li>
                                                    <li><a href="{{ route('men-category') }}">Watches</a></li>
                                                    <li><a href="{{ route('men-category') }}">Accessories</a></li>
                                                    <li><a href="{{ route('men-category') }}">Jewellery</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
    ...
    <div class="container">
        <div class="footer-grids">
            ...
            <div class="col-md-3 footer-grid">
                <h4>Information</h4>
                <ul>
                    <li><a href="{{ route('/') }}l">Home</a></li>
                    <li><a href="{{ route('women-category') }}">Women Products</a></li>
                    <li><a href="{{ route('men-category') }}">Men Products</a></li>
                    <li><a href="{{ route('codes') }}">Short Codes</a></li>
                    <li><a href="{{ route('mail-us') }}">Mail Us</a></li>
                </ul>
            </div>
