                                ...
                                <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Women's Wear</label>
                                    <ul>
                                        <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
                                            <ul>
                                                <li><a href={{ route('women-category') }}>Shirts</a></li>
                                                <li><a href={{ route('women-category') }}>Caps</a></li>
                                                <li><a href={{ route('women-category') }}>Shoes</a></li>
                                                <li><a href={{ route('women-category') }}>Pants</a></li>
                                                <li><a href={{ route('women-category') }}>SunGlasses</a></li>
                                                <li><a href={{ route('women-category') }}>Trousers</a></li>
                                            </ul>
                                        </li>
                                                    ...
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                                <div class="grid-img">
                                                                    <img  src="{{ asset('/') }}/front-end/images/p6.jpg" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="grid-img">
